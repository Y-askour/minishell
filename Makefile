...
#    Updated: 2022/09/05 11:09:50 by aboudoun         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BUILTIN = $(addprefix builtin/, builtins  echo export helpers pwd unset export_helper export_helper2 cd cd_helper)
...
FILES =  $(addprefix src/, minishell prompt heredoc heredoc_utils $(FREE) $(PARSER) $(SYNTAX) $(TOKENIZER) $(ERROR) $(EXECUTION))
